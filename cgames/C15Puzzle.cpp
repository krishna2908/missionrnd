...
void c15Puzzle_main(){
	...
	int table[][4] = { { 5, 4, 1, 2 }, { 3, 8, 9, 7 }, { 6, 12, 10, 11 }, { 14, 13, 15, 0 } };
	...
	initializeBoard(board, &table[0][0], rows, cols);
